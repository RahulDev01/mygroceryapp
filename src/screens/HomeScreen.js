  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomView}>
        ...
        >
          <Image
            source={selectedTab == 2 ? require("../images/wishlist_fill.png") : require("../images/wishlist.png")}
            style={styles.bottomTabIcon}
          />
        </TouchableOpacity>
        ...
        >
          <Image
            source={selectedTab == 3 ? require("../images/noti_fill.png"): require("../images/noti.png")}
            style={styles.bottomTabIcon}
          />
        </TouchableOpacity>
